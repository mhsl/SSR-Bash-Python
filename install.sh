...
if [[ $1 == "develop" ]];then
	wget -q -N --no-check-certificate -O /usr/local/bin/ssr https://gitee.com/iii80/SSR-Bash-Python-New/raw/develop/ssr
	chmod +x /usr/local/bin/ssr
else
	wget -q -N --no-check-certificate -O /usr/local/bin/ssr https://gitee.com/iii80/SSR-Bash-Python-New/raw/master/ssr
	chmod +x /usr/local/bin/ssr
fi
